...
class SignUpViewModel(val signUpCallback: (Credentials) -> Unit,
    ...
    fun onSubmit() {
        ...
        viewModelScope.launch {
            authRepo.signUp(
                ...
                connection = _uiState.value.connection
            ).collect { apiResource ->
    ...
    companion object {
        ...
        val AUTH_VIEW_MODEL_KEY = object : CreationExtras.Key<AuthViewModel> {}
        ...
        val Factory: ViewModelProvider.Factory = viewModelFactory {
            initializer {
                ...
                val authViewModel = this[AUTH_VIEW_MODEL_KEY] as AuthViewModel
